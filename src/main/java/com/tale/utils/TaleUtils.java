...
public class TaleUtils {
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (TaleUtils.class) {
            if (newDataSource == null) {
                Properties properties = TaleUtils.getPropFromFile(TaleUtils.location + "jdbc.properties");
                ...
                managerDataSource.setUrl(properties.getProperty("url"));
    ...
    public static Integer getCookieUid(HttpServletRequest request) {
        if (null != request) {
            Cookie cookie = cookieRaw(TaleConst.USER_IN_COOKIE, request);
            if (cookie != null && cookie.getValue() != null) {
                try {
                    String uid = Tools.deAes(cookie.getValue(), TaleConst.AES_SALT);
    ...
    public static void setCookie(HttpServletResponse response, Integer uid) {
        try {
            ...
            boolean isSSL = false;
            Cookie cookie = new Cookie(TaleConst.USER_IN_COOKIE, val);
            cookie.setPath("/");
