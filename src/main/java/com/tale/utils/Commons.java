...
public final class Commons {
     ...
     * @return
     */
    public static boolean is_empty(List<Object> list) {
    ...
    public static String site_option(String key, String defalutValue) {
        ...
        String str = TaleConst.initConfig.get(key);
    ...
    public static String gravatar(String email) {
        ...
        return "/static/user/img/identicon.png";
    }
    ...
    public static Map<String, String> social() {
        ...
        map.put("weibo", TaleConst.initConfig.get(prefix + "weibo"));
        map.put("zhihu", TaleConst.initConfig.get(prefix + "zhihu"));
        map.put("github", TaleConst.initConfig.get(prefix + "github"));
        map.put("twitter", TaleConst.initConfig.get(prefix + "twitter"));
        return map;
    }
}
